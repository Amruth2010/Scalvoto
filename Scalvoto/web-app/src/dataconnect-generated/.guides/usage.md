...
```ts
import { useSeedDemoData, useListMovies, useCreateList, useAddMovieToList } from '@dataconnect/generated/react';
// The types of these hooks are available in react/index.d.ts

const { data, isPending, isSuccess, isError, error } = useSeedDemoData();
...
```js
import { seedDemoData, listMovies, createList, addMovieToList } from '@dataconnect/generated';


// Operation SeedDemoData: 
